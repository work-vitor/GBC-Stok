...
<body style="background-color: #EEE9E9;">
	...
	<div class="container" id="logao" style="background-color: white;">
		<form action="action/update_fornecedor.php" method="POST" >
			...
			// Filtrando os dados do Banco
				...
				while ($array = mysqli_fetch_array($select3)) {
					...
					<div class="form-group" style="padding: 10px;">
						...
						<input type="number" name="id_fornecedor" value="<?php echo $id_fornecedor;?>" hidden>
					</div>

					<div style="text-align: right;">
						<a href="listar_fornecedor.php" class="btn btn-sm  btn-danger">Voltar</a>
