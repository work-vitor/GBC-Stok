...
<body style="background-color: #EEE9E9;">
	...
	<div class="container" id="logao" style="background-color: white;">
		<form action="action/update_categoria.php" method="POST" >

			<div style="padding: 20px;">
				<center>
					<img src="img/categoria.png" width="100px" height="100px"> 
				</center>
			...
			// Filtrando os dados do Banco
				$sql3 = "SELECT * FROM categoria WHERE id_categoria = $id";
				...
				while ($array = mysqli_fetch_array($select3)) {
					...
					<div class="form-group" style="padding: 10px;">
						...
						<input type="number" name="id_categoria" value="<?php echo $id_categoria;?>" hidden>
					</div>

					<div style="text-align: right;">
						<a href="listar_categoria.php" class="btn btn-sm  btn-danger">Voltar</a>
