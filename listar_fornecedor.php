		...
		<table class="table">
			...
			<tr >
				...
				while ($array = mysqli_fetch_array($select)) {
					...
					?>
					<tr >
						<td class="table-secondary"><?php echo $id_fornecedor;?></td>

						<td class="table-secondary"><?php echo $nome_fornecedor;?></td>
						...
						if (($nivel == 1) or ($nivel == 2) ) {
							...
							<td class="table-secondary">
								<a class="btn btn-warning btn-sm" href="editar_fornecedor.php?id=<?php echo $id_fornecedor?>"><i class="fas fa-edit" role="button"></i>&nbsp;Editar</a>
								<a class="btn btn-danger btn-sm" href="action/deletar_fornecedor.php?id=<?php echo $id_fornecedor?>" role="button" style="color: black;"><i class="far fa-trash-alt "></i>&nbsp;Excluir</a>
							</td>
						<?php } ?>
					</tr>
				<?php }?>
