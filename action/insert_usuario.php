...
$nivel_acesso = $_POST['nivel_usuario'];

$status = "Ativo";
// Inserindo no Banco

$sql = "INSERT INTO usuarios (nome_usuario, email, senha, nivel_usuario, status) values ('$nome_usuario', '$email', sha1('$senha'), '$nivel_acesso', '$status')";
